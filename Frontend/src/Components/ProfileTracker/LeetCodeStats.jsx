...
const LeetCodeStats = () => {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="grid w-full gap-4 lg:grid-cols-1">
        {/* Stats Cards */}
        <div className="col-span-2 grid md:grid-cols-2 gap-4">
          <StatCard
            title="Total Questions"
            value={
              data?.stats?.find((stat) => stat.difficulty === "All")?.count || 0
            }
          />
        ...
        {/* Responsive Heatmap */}
        <div className="w-full bg-white border rounded-lg shadow-sm lg:col-span-3">
          <div className="w-full overflow-x-auto">
            <div className="p-2 sm:p-4 border rounded-lg shadow-sm bg-white w-full">
              <CalendarHeatmap
                startDate={
...
const AwardsSection = ({ badges, showMore, setShowMore }) => (
  <div className="p-4 bg-white border rounded-lg shadow-sm">
    ...
    <div className="flex justify-center gap-4 mt-2 flex-wrap items-center">
      {badges?.length > 0 ? (
        badges.map((badge, index) => (
          <img
            ...
            onError={(e) => {
              e.target.src =
                "https://cdn3.iconfinder.com/data/icons/ui-thick-outline-3-of-5/100/ui_05_of_9-06-512.png";
